...
CONFIG = {
    'Chinese': {
        ...
        'checkpoint_dir': PWD + "/logs/csmsc/",
        'checkpoint_file': PWD + "/logs/csmsc/G_414000.pth",
        'output_dir': PWD + "/outputs/Chinese/"
    },
    'English': {
        'config_file': PWD + "/configs/ljs_base.json",
        'checkpoint_dir': PWD + "/logs/ljs_base/",
        'checkpoint_file': PWD + "/logs/ljs_base/G_478000.pth",
